package com.example.latihanmenampilkanwidgetdihomepage
...
class RandomNumberWidget : AppWidgetProvider() {
    ...
    // untuk menangani aksi ketika tombol ditekan
...
internal fun updateAppWidget(
    ...
    val lastUpdate = "Random: " + NumberGenerator.generate(100)
    // RemoteViews adalah komponen yang dapat kita gunakan untuk mengambil data layout dari widget
    val views = RemoteViews(context.packageName, R.layout.random_number_widget)
    views.setTextViewText(R.id.appwidget_text, lastUpdate)
